...
insert into tt_db_deploy_tgt (txt_config_var_assignment) values ('dpltgt_master_password=dqmadmin');
...
insert into tt_db_deploy_tgt (txt_config_var_assignment) values ('dpltgt_ldd_local_password=dqmadmin');
...
insert into tt_db_deploy_tgt (txt_config_var_assignment) values ('dpltgt_ldd_repl_password=dqmadmin');
...
insert into tt_db_deploy_tgt (txt_config_var_assignment) values ('dpltgt_aurep_local_password=dqmadmin');
...
insert into tt_db_deploy_tgt (txt_config_var_assignment) values ('dpltgt_aurep_repl_password=dqmadmin');
